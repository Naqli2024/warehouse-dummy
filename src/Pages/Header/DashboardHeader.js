...
const DashboardHeader = () => {
  ...
  const drawerContent = (
    ...
    >
      <List>
        ...
        <div className="account-profile" onClick={handleAccount}>
        <PersonIcon className="drawer-person-icon" style={{ width: "30px", height: "30px" }}/>
        <div>
          <p>Jackson</p>
          <p className="text-secondary">jackson04@gmail.com</p>
        </div>
        </div>
        <p>User Id:00032849333948</p>
        </div>
        <hr className="m-0" />
        <div  className="right-drawer">
        ...
        <div>
          ...
          <p className="text-primary cursor-pointer" onClick={handleEmployeeDetails}>View</p>
          </div>
        </div>
        </div>
        </div>
        ...
        <hr className="m-0" />
          ...
          <ListItem>
            <PiSignOut size={20}/>
            <ListItemButton className="text-danger">Sign-Out</ListItemButton>
          </ListItem>
      </List>
    </Box>
  );
  ...
  return (
    <div class="dashboard-top-content">
            ...
            <div class="ms-auto dashboard-group">
              ...
              <div className="notification-profile">
                ...
                <div className="dashboard-profile">
                  <PersonIcon onClick={() => toggleDrawer(true)} style={{ width: "30px", height: "30px" }} />
                </div>
              </div>
            </div>
          </div>
      ...
      <Drawer  size={'sm'} anchor="right" open={drawerOpen} onClose={() => toggleDrawer(false)}>
        {drawerContent}
      </Drawer>
    </div>
  );
