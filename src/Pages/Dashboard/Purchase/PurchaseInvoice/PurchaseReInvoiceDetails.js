...
import PurchaseReInvoiceReceipt from "./PurchaseReInvoiceReceipt";

const PurchaseReInvoiceDetails = ({ backToList }) => {
  ...
  return (
    <div className="purchase-list">
      ...
      <div className="edit-print-del-btn mb-3">
        ...
        <div className="divider"></div>
       <div className="ms-2 me-2 cursor-pointer">Revise Invoice</div>
        <div className="divider"></div>
        <React.Fragment>
          <Menu
      ...
      <div>
        ...
        >
          <AccordionSummary
            ...
            id="panel2a-header"
          >
            <Typography sx={{ fontWeight: "bold" }}>Debit note</Typography>
          </AccordionSummary>
          <AccordionDetails>
            <Typography>
              <PurchaseReInvoiceReceipt />
      ...
      <p className="paid-label">Paid</p>
        ...
        <div className="sales-invoice">
          ...
          <div className="sales-order-date me-5">
            <p className="detail-heading mb-1">RE-Invoice</p>
            <p className="sales-id-text">RIN:#54675</p>
          </div>
        </div>
...
export default PurchaseReInvoiceDetails;
