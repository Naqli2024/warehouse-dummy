...
const NewPurchaseReturnDetails = ({backToList}) => {
  ...
  return (
    ...
    <div className="sales-invoice-outer-card mt-5">
      <p className= "delivered-label">Closed</p>
      <div className="sales-invoice-detail">
        <div className="sales-invoice">
          ...
          <div className="sales-order-date">
            <p className="detail-heading mb-1 fw-bold">PURCHASE RETURN</p>
            <p className="sales-id-text">PR#36646367</p>
          </div>
        </div>
...
export default NewPurchaseReturnDetails