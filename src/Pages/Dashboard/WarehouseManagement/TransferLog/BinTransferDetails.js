...
const BinTransferDetails = ({backToList}) => {
  ...
  return (
    ...
    <div className="transferLog-container">
      ...
      <div className="col-md-5 transfer-layout-large">
        <div className="d-flex justify-content-center align-items-center">
          ...
          <div className="flex-column align-items-end">
            <div className="transfer-person-horizontal-divider"></div>
            <div className="transfer-contact-container">
              <div className="transfer-person-vertical-divider"></div>
              <div className="transfer-card">
                <p>Contact person</p>
      ...
      <div className="col-md-3 store transfer-layout-small" style={{ display: "none" }}>
      <div className="transfer-card ">
              <p>Source Shelf Space</p>
              <p className="fw-bold">A4</p>
            </div>
...
export default BinTransferDetails