...
const SalesInvoiceDetails = ({ backToList }) => {
    ...
    <div className="purchase-list">
      ...
      <div className="edit-print-del-btn mb-3">
        ...
        {paymentStatus == "paid" && (
          <>
            <>
              <div className="ms-2 me-2 cursor-pointer" onClick={handleOpenNewCredit}>Create Credit note</div>
              <div className="divider"></div>
            </>
          </>
        )}
